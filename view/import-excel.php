            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group input-group-sm has-validation">
                        ...
                        <input type="number" placeholder="" class="form-control" name="namHoc" id="namHoc" required
                            min="1900" max="3000" minlength="4" maxlength="4" value="' .$currentYear. '" onchange="updateNextYear()" onblur="validateYearInput()">
...
<div class="col-md-6 mt-4">
    <div class="form-group input-group-sm has-validation">
        ...
        <input type="number" placeholder="" readonly class="form-control" name="namHoc2" id="namHoc2" required min="1900"
            max="3000" value="' .($currentYear + 1) . '">
        <div class="invalid-feedback">
            Hãy nhập năm học!.
        </div>
    </div>
...
<div class="form-group">
    <label for="fileToUpload" class="font-weight-bold d-inline-block"><i class="bi bi-file-excel" ></i> Chọn tệp Excel để nhập:</label>
    <input type="file" class="form-control form-control-lg" name="fileToUpload" id="fileToUpload" accept=".xls,.xlsx"
        required>
