...
<div class="d-sm-flex align-items-center justify-content-between mb-4  ">
    <h1 class="h3 mb-0 text-gray-800">Yêu cầu chỉnh sửa cá nhân</h1>
...
<span class="badge rounded-pill text-bg-info mb-3">  Lịch sử yêu cầu</span>
</div>
...
<script src="../js/load-lichsuyeucau.js"></script>
